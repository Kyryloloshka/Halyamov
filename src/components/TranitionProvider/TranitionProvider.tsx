    ...
    <AnimatePresence mode="wait">
      <motion.div key={pathname} className="w-screen h-screen relative">
        ...
        <motion.div
          ...
          animate={{
            width: "0vw",
            transition: { delay: 0.8, ease: "easeInOut", duration: 0.8 },
          }}
        ></motion.div>
        <motion.div
          ...
          animate={{
            width: "0vw",
            transition: { delay: 0.9, ease: "easeInOut", duration: 0.8 },
          }}
        ></motion.div>
        <motion.div
        ...
        ></motion.div>
        <motion.div className="w-screen h-screen flex flex-col cont__container">
          {children}
        </motion.div>
      </motion.div>
    </AnimatePresence>
